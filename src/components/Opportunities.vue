    ...
    export default {
        ...
        data() {
            return {
                ...
                opportunities: [
                    new Opportunity('This One', "7/20/2020"),
                    new Opportunity('That One', "4/14/2020"),
                    new Opportunity('That One', "7/20/2013"),
                    new Opportunity('That One', "1/13/2002"),
                    new Opportunity('That One', "7/12/2010"),
                    new Opportunity('The Other', "6/31/2004")
                ],
                volunteers:[
